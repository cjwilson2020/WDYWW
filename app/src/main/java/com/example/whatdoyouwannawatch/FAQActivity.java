...
public class FAQActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listItems.add("To create a new Theatre, click the 'Watch Now' button, and then the 'Create Theatre' button. " +
                "You will now be in your newly created Theatre!");

        listItems.add("How do I join my friend's Theatre?");
        listItems.add("From the home screen, click the 'Watch Now' button, and then click the 'Join Theatre button. From" +
        ...
        listItems.add("Once everyone in your group has joined the Theatre, the host can click the 'I'm all set' button, and the " +
                        "ranking process will begin!");

        listItems.add("How do I log out of my account?");
        listItems.add("To log out of your account, navigate to the home screen and click the 'Log Out' button at the bottom of the screen.");

        listItems.add("Can I save my preferred genres so that I don't have to add them each time?");
        listItems.add("Yes! To save your preferred genres, click on the 'Settings' button from the home screen, then click" +
        ...
        listItems.add("To add a profile image, click on the 'Profile' button from the home screen. You will be navigated to your profile" +
